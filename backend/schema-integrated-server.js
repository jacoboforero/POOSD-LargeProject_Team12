...
// Define schemas inline to match your contracts
...
const UsageResponseSchema = z.object({
  ...
  completedBriefings: z.number(),
  queuedBriefings: z.number(),
  failedBriefings: z.number(),
  dailyUsage: z.number(),
  quota: z.object({
    daily: z.number(),
    monthly: z.number(),
...
app.listen(PORT, () => {
  console.log(`🚀 Schema-integrated server running on port ${PORT}`);
  console.log(`📋 Using Zod schemas for validation (matching your contracts)`);
});
